...
public class QuizGameLevel3 : MonoBehaviour
{
    ...
    private int score = 0;
    public static int scoresetlevel3;
    ...
    IEnumerator ContinueAfterFeedback()
    {
        ...
        questionsDone++;
        scoreText.text = "Result: " + score.ToString() + "/" + questionsDone.ToString();
    ...
    void DisplayResults()
    {
        ...
        scoresetlevel3 = score;
        print("scoresetlevel3 :- " + scoresetlevel3);
    }
